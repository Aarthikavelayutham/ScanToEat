...
def ai_recommendations(request):
    ...
    if intent == 'time':
        ...
        if items.exists():
            reply = "I found exactly what you're looking for on our menu! 🍽️ Here's the best of what we have:"
        elif len(message) < 10:
             reply = "Hello! I'm your AI Chef. 👨‍C I can recommend food, answer questions about our restaurant, or help you find specific ingredients. What's on your mind?"
        else:
             reply = "That's an interesting question! 👨‍C While I focus on our menu and kitchen, I recommend trying these best-sellers while you wait for your answer:"
             items = all_items.order_by('?')[:3]
